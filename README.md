...
> LlamaGuard pipeline scanning retrieved contexts for toxic content and prompt injection payloads.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/protecrag/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-protecrag.git
cd tp-protecrag
```
...
```bash
kubectl port-forward deployment/tp-protecrag 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── guardrails_rules.yaml     # Main configuration file
```
...
---
*Generated by [ProtecRAG Studio](https://pradeeptalari14.github.io/portfolio/tools/protecrag/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
